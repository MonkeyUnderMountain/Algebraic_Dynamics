\section{A theorem for attractor of endomorphism on k-affinoid spaces}
    ...
    \paragraph{Assumption} We further assume that there exists a subvariety \(\tilde{Z} \subseteq \tilde{X}\) such that \(\tilde{f}(\tilde{X}) = \tilde{Z}\) and \(\tilde{f}|_{\tilde{Z}}\) is an automorphism of \(\tilde{Z}\).

    \begin{proposition}
        prop of stable and distinguished
    \end{proposition}
    Recall that \(A\) is called distinguished if there exists a surjective morphism \(\kkk\{ x_1, \ldots, x_n \} \to A\) such that the induced norm on \(A\) coincides with the spectral norm \(\rho_A\).
    ...
    \begin{theorem}[{ref. \cite[Theorem 8.3]{Xie25ZDOsurfaces}}]\label{thm:attractor_is_Zariski_closed_and_endomorphism_descends}
        ...
        \end{enumerate}
        Moreover, there exists \(C>0\), \(0 < \lambda < 1\) such that for any \(x \in X\) and any \(n \geq 0\), we have
        \[ d\left( f^n(x), f^n(\psi(x)) \right) \leq C \lambda^n. \]
        \Yang{To be revised.}
    \end{theorem}
